export const blog = [
  ...
  },
  {
    ...
    text: "As the world increasingly embraces cryptocurrency, the need for secure storage solutions becomes paramount. Cryptocurrency wallets, whether hardware, software, or paper, serve as the gateway to our digital assets. Yet, despite their essential role, many users remain blissfully unaware of the vulnerabilities that can compromise their funds.",
    link: "Read More",
  },
];
